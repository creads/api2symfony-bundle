...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'api2symfony.converter.raml' => 'getApi2symfony_Converter_RamlService',
            'api2symfony.dumper' => 'getApi2symfony_DumperService',
    ...
    /**
     * Gets the 'api2symfony.converter.raml' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Creads\Api2Symfony\Converter\RamlConverter A Creads\Api2Symfony\Converter\RamlConverter instance.
     */
    protected function getApi2symfony_Converter_RamlService()
    {
        return $this->services['api2symfony.converter.raml'] = new \Creads\Api2Symfony\Converter\RamlConverter(new \Raml\Parser());
    }

    /**
     * Gets the 'api2symfony.dumper' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Creads\Api2SymfonyBundle\Api2SymfonyDumper A Creads\Api2SymfonyBundle\Api2SymfonyDumper instance.
     */
    protected function getApi2symfony_DumperService()
    {
        return $this->services['api2symfony.dumper'] = new \Creads\Api2SymfonyBundle\Api2SymfonyDumper($this->get('templating'), $this->get('filesystem'), (__DIR__.'/api2symfony'));
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[4].'/vendor/symfony/framework-bundle/Symfony/Bundle/FrameworkBundle/Resources/views'), 'Framework');
        $instance->addPath(($this->targetDirs[4].'/vendor/symfony/twig-bundle/Symfony/Bundle/TwigBundle/Resources/views'), 'Twig');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('supersecret');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'Api2SymfonyBundle' => 'Creads\\Api2SymfonyBundle\\Api2SymfonyBundle',
            ),
            ...
            'raml.parser.class' => 'Raml\\Parser',
            'api2symfony.converter.raml.class' => 'Creads\\Api2Symfony\\Converter\\RamlConverter',
            'api2symfony.dumper.class' => 'Creads\\Api2SymfonyBundle\\Api2SymfonyDumper',
